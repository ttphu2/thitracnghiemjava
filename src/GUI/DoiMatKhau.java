...
public class DoiMatKhau extends javax.swing.JDialog {
   ...
   private static NguoiDungDTO user;
    public DoiMatKhau(java.awt.Dialog parent, boolean modal, NguoiDungDTO user) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(433, 338));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DoiMatKhau dialog = new DoiMatKhau(new javax.swing.JDialog(), true,user);
